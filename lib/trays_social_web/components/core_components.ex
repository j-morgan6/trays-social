defmodule TraysSocialWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TraysSocialWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TraysSocialWeb.Gettext, "errors", msg, opts)
    end
  end
