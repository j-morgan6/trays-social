defmodule TraysSocialWeb.API.V1.NotificationController do
  ...
  def index(conn, params) do
    ...
    # D67: hide notifications generated by users the viewer has blocked
    # (e.g., a blocked user commenting on the viewer's post). Mirrors the
    # D65 fix shipped for comment listings — same Accounts.blocked_user_ids/1
    # helper, same opt name, threaded the same way.
    blocked_user_ids = Accounts.blocked_user_ids(user.id)
